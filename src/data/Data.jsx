export const Education_data = [
  ...
  },
  {
    ...
    school: "Bright Day School, Gujarat",
    year: "2014-2016",
...
export const Project_data = [
  ...
  },
  {
    ...
    name: "Portfolio App",
    key_skills: "Html, Css, Reactjs, Chakra UI, Bootstrap, EmailJs",
    description: [
  ...
  },
  {
    ...
    description: [
      "Certain pre-processing methods for cleaning the twitter dataset was performed.",
      "The accuracy was tested on classifiers(SVM, naive Bayes, Decision tree, Random Forest, KNN)",
    ],
    website: "",
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "Voter can get the List and history of the candidates based on the area of voter",
    ],
    website: "",
  },
];
